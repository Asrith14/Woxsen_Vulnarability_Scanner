...
# Tool       : RapidScan v1.1
# Usage      : python3 woxsenscanner2.py
...
def helper():
        ...
        print("------------")
        print("\t.python3 woxsenscanner2.py example.com: Scans the domain example.com.")
        print("\tpython3 woxsenscanner2.py example.com --skip dmitry --skip theHarvester: Skip the 'dmitry' and 'theHarvester' tests.")
        print("\tpython3 woxsenscanner2.py example.com --nospinner: Disable the idle loader/spinner.")
        print("\tpython3 woxsenscanner2.py --update   : Updates the scanner to the latest version.")
        print("\tpython3 woxsenscanner2.py --help     : Displays this help context.")
...
def logo():
    ...
    logo_ascii = """
                     ...
                     Team - Nikhil, Asrith , Sammer         Mentor - proff vaishali  
                     
                     WOXSEN WEB VULNERABILITY SCANNER, """+bcolors.BG_LOW_TXT+"""NetBot"""+bcolors.ENDC+""" 
    """
    print(logo_ascii)
    print(bcolors.ENDC)
